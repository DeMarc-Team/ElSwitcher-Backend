...
def deshacer_movimiento(db: Session, id_partida, id_jugador):
    ...
    if (partida.jugador_del_turno.id_jugador != id_jugador):
        raise ForbiddenError(
            f"El ID del jugador que posee el turno no es {id_jugador}.")
