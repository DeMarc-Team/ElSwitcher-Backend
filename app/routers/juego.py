...
async def get_movimientos_jugador(partida_id: int, jugador_id: int, db: Session = Depends(get_db)):
    return crud.juego.get_movimientos_jugador(db, partida_id, jugador_id)