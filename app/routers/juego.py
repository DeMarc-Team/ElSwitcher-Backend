...
@router.get('/{partida_id:int}/jugadores/{jugador_id:int}/cartas_figura',
            ...
            tags=["Juego"])
async def get_cartas_figura_jugador(partida_id: int, jugador_id: int, controller: GameController = Depends(get_game_controller)):
...
@router.get('/{id_partida:int}/jugadores/{id_jugador:int}/cartas_movimiento',
            ...
            tags=["Juego"])
async def get_movimientos_jugador(id_partida: int, id_jugador: int, controller: GameController = Depends(get_game_controller)):
...
@router.get('/{id_partida:int}/turno',
            ...
            tags=["Juego"])
async def get_turno_details(id_partida: int, controller: GameController = Depends(get_game_controller)):
...
@router.put('/{id_partida:int}/jugadores/{id_jugador:int}/turno',
            ...
            tags=["Juego"])
async def terminar_turno(id_partida: int, id_jugador: int, controller: GameController = Depends(get_game_controller)):
...
@router.get('/{id_partida:int}/tablero',
            ...
            tags=["Juego"])
async def get_tablero(id_partida: int, controller: GameController = Depends(get_game_controller)):
...
@router.put('/{id_partida}/jugadores/{id_jugador}/tablero/casilla',
            ...
            tags=["Juego"])
async def modificar_casillas(id_partida: int, id_jugador: int, coordenadas: CasillasMov, controller: GameController = Depends(get_game_controller)):
...
@router.delete('/{id_partida}/jugadores/{id_jugador}/mov-parciales',
               ...
               tags=["Juego"])
async def deshacer_movimiento(id_partida: int, id_jugador: int, controller: GameController = Depends(get_game_controller)):
...
@router.get('/{id_partida}/jugadores/{id_jugador}/mov-parciales',
               ...
               tags=["Juego"])
async def get_movimientos_parciales(id_partida: int, id_jugador: int, controller: GameController = Depends(get_game_controller)):
...
@router.put('/{id_partida:int}/jugadores/{id_jugador:int}/tablero/figura',
            ...
            tags=["Juego"])
async def completar_figura_propia(id_partida: int, id_jugador: int, figura_data: CompletarFiguraData, controller: GameController = Depends(get_game_controller)):
