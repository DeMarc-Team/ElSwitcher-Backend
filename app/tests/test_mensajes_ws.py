...
def test_create_partida_ws(client, expected_msgs_home_ws):
...
# ----------------------------------------------------------
def test_unirse_partida_ws(client, expected_msgs_home_ws, expected_msgs_partidas_ws):
...
def test_iniciar_partida_ws(client, expected_msgs_home_ws, expected_msgs_partidas_ws):
...
def test_terminar_turno_ws(client, expected_msgs_partidas_ws):
...
def test_abandonar_partida_sin_ganador_ws(client, expected_msgs_home_ws, expected_msgs_partidas_ws):
...
def test_abandonar_partida_con_ganador_ws(client, expected_msgs_partidas_ws):
    with mock.patch('routers.partidas.crud.abandonar_partida', new=mock.MagicMock()) as mock_delete_jugador:
...
def test_abandonar_partida_ycancelar_ws(client, expected_msgs_home_ws, expected_msgs_partidas_ws):
    with mock.patch('routers.partidas.crud.abandonar_partida', new=mock.MagicMock()) as mock_delete_jugador:
...
def test_completar_figura_propia_con_ganador_ws(client, expected_msgs_partidas_ws):
...
def test_completar_figura_propia_ws(client, expected_msgs_partidas_ws):
    with mock.patch('routers.juego.crud.juego.completar_figura_propia', new=mock.MagicMock()) as mock_service:
