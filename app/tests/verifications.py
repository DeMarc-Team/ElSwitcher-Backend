...
def check_jugador_abandoned(test_db, numero_de_jugadores_esperados, id_jugador_que_abandono, id_partida):
    ...
    assert partida.jugador_del_turno.id_jugador != id_jugador_que_abandono, \
        f"Fallo: Se esperaba que el jugador del turno no fuera el jugador que abandonó, pero se obtuvo {partida.jugador_del_turno.id_jugador}"
