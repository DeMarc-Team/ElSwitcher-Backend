...
from controllers.JuegoController import iniciar_temporizador_turno, terminar_temporizador_del_turno, log_abandona
class PartidaController:
    ...
    async def abandonar_partida(self, partida_id, jugador_id):
        ...
        await log_abandona(partida_id, jugador_id)
